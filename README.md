...
This model is made for 224x224x3 images, but in this model, it is implemented on 32x32x3 images, so the learable parameters changed from 134 million to 43 million.<br />
To check out the whole architecture with details, run data_loader.py, then run model.py. The details will be shown using model.summary() method.
